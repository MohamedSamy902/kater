<?php $__env->startSection('title'); ?>
    <?php echo e(__('master.add_wellBeing')); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post"
                            action="<?php echo e(route('wellBeing.update', $wellBeing->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="title"
                                        required=""
                                        value="<?php echo e(old('title') ? old('title') : $wellBeing->getTranslation('title', 'en')); ?>" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" type="text" name="title_ar"
                                        required=""
                                        value="<?php echo e(old('title_ar') ? old('title_ar') : $wellBeing->getTranslation('title', 'ar')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="editor1" cols="30" rows="10" class="form-control" id="validationCustom03" type="text"
                                        name="content" required=""><?php echo e(old('content') ? old('content') : $wellBeing->getTranslation('content', 'en')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="editor2" cols="30" rows="10" class="form-control" id="validationCustom04" type="text"
                                        name="content_ar" required=""><?php echo e(old('content_ar') ? old('content_ar') : $wellBeing->getTranslation('content', 'ar')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom03" type="text" name="short_content"
                                        required=""><?php echo e(old('short_content') ? old('short_content') : $wellBeing->getTranslation('short_content', 'en')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom04" type="text" name="short_content_ar"
                                        required=""><?php echo e(old('short_content_ar') ? old('short_content_ar') : $wellBeing->getTranslation('short_content', 'ar')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="convoys"
                                        required=""
                                        value="<?php echo e(old('convoys') ? old('convoys') : $wellBeing->getTranslation('convoys', 'en')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" type="text" name="convoys_ar"
                                        required=""
                                        value="<?php echo e(old('convoys_ar') ? old('convoys_ar') : $wellBeing->getTranslation('convoys', 'ar')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="services"
                                        required=""
                                        value="<?php echo e(old('services') ? old('services') : $wellBeing->getTranslation('services', 'en')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" type="text"
                                        ...
                                        value="<?php echo e(old('services_ar') ? old('services_ar') : $wellBeing->getTranslation('services', 'ar')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" id="validationDefault06" name="status">
                                        <option value="active"  <?php echo e($wellBeing->status == 'active' ? 'selected' : ''); ?>> Active</option>
                                        <option value="inactive" <?php echo e($wellBeing->status == 'inactive' ? 'selected' : ''); ?>> InActive</option>
                                    </select>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" id="validationCustom02" type="text" name="order_by" value="<?php echo e(old('order_by') ? old('order_by') : $wellBeing->order_by); ?>" />
                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/kater/resources/views/dashbord/wellbeing/edit.blade.php ENDPATH**/ ?>