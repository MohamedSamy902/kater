                                ...
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <div class="product-hover">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="<?php echo e(route('galleriesgDetails.deleteImage', $galler->id)); ?>"><i class="fa fa-trash"></i></a>
                                                </li>
                                                <li>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/perfectchoice/public_html/kater/resources/views/dashbord/gallery/show.blade.php ENDPATH**/ ?>