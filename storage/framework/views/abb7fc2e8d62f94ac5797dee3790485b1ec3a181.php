                        ...
                        <form class="needs-validation" method="post"
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom03" type="text" name="content" required=""><?php echo e(old('content') ? old('content') : $healthcare->getTranslation('content', 'en')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom04" type="text" name="content_ar" required=""><?php echo e(old('content_ar') ? old('content_ar') : $healthcare->getTranslation('content', 'ar')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <img src="<?php echo e($healthcare->getFirstMediaUrl('healthcareImage ')); ?>"
                                        alt="">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Documents/kater/resources/views/dashbord/healthcare/edit.blade.php ENDPATH**/ ?>