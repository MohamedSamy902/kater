<?php $__env->startSection('title'); ?>
    <?php echo e(__('master.add_healthcareDetalis')); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post"
                            action="<?php echo e(route('healthcareDetails.update', $healthcareDetalis->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" name="title"
                                        required=""
                                        value="<?php echo e(old('title') ? old('title') : $healthcareDetalis->getTranslation('title', 'en')); ?>" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" type="text" name="title_ar"
                                        required=""
                                        value="<?php echo e(old('title_ar') ? old('title_ar') : $healthcareDetalis->getTranslation('title', 'ar')); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/perfectchoice/public_html/kater/resources/views/dashbord/healthcare/image/edit.blade.php ENDPATH**/ ?>