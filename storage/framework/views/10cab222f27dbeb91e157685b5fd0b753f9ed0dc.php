    ...
    <div class="container-fluid product-wrapper">
        <div class="product-grid">
            ...
            <div class="product-wrapper-grid">
                <h2 class="text-center"><?php echo e($healthcare->title); ?></h2>

                <div class="row">
                    <?php $__currentLoopData = $healthcare->healthcareDetalis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $well): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xl-3 col-sm-6 xl-4">
                            <div class="card">
                                <div class="product-box">
                                    <div class="product-img">
                                        <img class="img-fluid" src="<?php echo e($well->getFirstMediaUrl('healthcareDetails')); ?>"
                                            alt="" />
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/perfectchoice/public_html/kater/resources/views/dashbord/healthcare/show.blade.php ENDPATH**/ ?>