                    ...
                    <div class="main-menu__logo">
                        <?php
                            if (App::getLocale() == 'ar') {
                                ...
                                echo '<a href=""><img src=" ' . asset('site') . '/assets/images/loader.png" alt="" width="200px" class="pb-2"></a>';
                            }
                        ?>
                    </div>
                    ...
                    <div class="main-menu__right-bottom">
                        <div class="main-menu__main-menu-box">
                            ...
                            <ul class="main-menu__list">
                                ...
                                <li class="current megamenu"><a href="<?php echo e(route('gallery')); ?>"><?php echo e(__('site.event')); ?>
...
<?php /**PATH /home/mohamed/Desktop/project/kater/masterLaravel/resources/views/site/layout/header.blade.php ENDPATH**/ ?>