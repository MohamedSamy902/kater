                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="causes-one__single">
                            ...
                            <div class="causes-one__content">
                                ...
                                <p class="causes-one__text"> <?php echo e(Str::limit($wellBeing[0]->content, 205, ' .....')); ?></p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                    <div class="causes-one__single">
                        ...
                        <div class="causes-one__content">
                            ...
                            <p class="causes-one__text"><?php echo e(Str::limit($wellBeing[1]->content, 205, ' .....')); ?></p>
                        </div>
                    </div>
                </div>
                <!--Causes One Single End-->
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                    <div class="causes-one__single">
                        ...
                        <div class="causes-one__content">
                            ...
                            <p class="causes-one__text"><?php echo e(Str::limit($wellBeing[2]->content, 205, ' .....')); ?> </p>
                        </div>
                    </div>
                </div>
                <!--Causes One Single End-->
...
<?php echo $__env->make('site.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/project/kater/masterLaravel/resources/views/site/healthcare.blade.php ENDPATH**/ ?>