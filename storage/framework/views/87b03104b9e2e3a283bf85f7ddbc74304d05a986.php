                ...
                <nav class="pb-5">
                    ...
                    <div class="nav nav-tabs" id="nav-tab" role="tablist" style="justify-content: center;">
                        <button style="text-transform: unset;    font-family: var(--khater-font-three);"
                            class="nav-link active" id="nav-Photos-tab" data-bs-toggle="tab" data-bs-target="#nav-Photos"
                            type="button" role="tab" aria-controls="nav-Photos"
                        ...
                        <button style="text-transform: unset;" class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="false"><?php echo e(__('site.video')); ?></button>
                    </div>
                </nav>
                <?php endif; ?>
