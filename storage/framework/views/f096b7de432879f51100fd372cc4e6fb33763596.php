                            ...
                            <div class="card">
                                <div class="product-box">
                                    <div class="product-img">
                                        <img class="img-fluid" src="<?php echo e(url('media/' . $galler->id . '/' . $galler->file_name)); ?>"
                                            alt="" />
                                        <div class="product-hover">

                                            <ul>
                                                <li>
                                                    <a href="<?php echo e(route('image.deleteImage', $galler->id)); ?>"><i class="fa fa-trash"></i></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('galleriesgDetails.edit', $galler->id)); ?>"><i
                                                            class="icon-eye"></i></a>
                                                </li>
                                            </ul>
                                        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/kater/resources/views/dashbord/gallery/test.blade.php ENDPATH**/ ?>