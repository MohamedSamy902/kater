                    ...
                    <div class="card-body">
                        <form class="needs-validation" method="post"
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom03" type="text" name="short_content"
                                        required=""><?php echo e(old('short_content') ? old('short_content') : $healthcare->getTranslation('short_content', 'en')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea rows="5" class="form-control" id="validationCustom04" type="text" name="short_content_ar"
                                        required=""><?php echo e(old('short_content_ar') ? old('short_content_ar') : $healthcare->getTranslation('short_content', 'ar')); ?></textarea>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" id="validationDefault06" name="status">
                                        <option value="active"  <?php echo e($healthcare->status == 'active' ? 'selected' : ''); ?>> Active</option>
                                        <option value="inactive" <?php echo e($healthcare->status == 'inactive' ? 'selected' : ''); ?>> InActive</option>
                                    </select>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" id="validationCustom02" type="text" name="order_by" value="<?php echo e(old('order_by') ? old('order_by') : $healthcare->order_by); ?>" />
                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/kater/resources/views/dashbord/healthcare/edit.blade.php ENDPATH**/ ?>