                    ...
                    <div class="main-timeline9" style="top: -80px;">
                        <div class="timeline">
                            <div class="timeline-content line1">
                                ...
                                <div class="content">
                                    <p class="description"><?php echo e($TimeLine[0]->content); ?> </p>
                        ...
                        <div class="timeline">
                            <div class="timeline-content line2" style="margin-top: 50px">
                                ...
                                <div class="content">
                                    <p class="description"><?php echo e($TimeLine[1]->content); ?></p>
            ...
            <div class="thm-swiper__slider swiper-container"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide story"
                        ...
                        <img src="<?php echo e(asset('site')); ?>/assets/images/partners/National_Cancer_Institute_en.jpg"
                            alt="">
                    </div>
                    <div class="swiper-slide story"
...
<?php echo $__env->make('site.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed/Desktop/project/kater/masterLaravel/resources/views/site/about.blade.php ENDPATH**/ ?>