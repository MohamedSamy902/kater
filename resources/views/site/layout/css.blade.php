...
<!-- favicons Icons -->
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('site') }}/assets/images/2448648.png" />
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('site') }}/assets/images/2448648.png" />
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('site') }}/assets/images/2448648.png" />
...
<link rel="stylesheet" href="{{ asset('site') }}/assets/vendors/khater-icons/style.css">
...
<!-- template styles -->
<link rel="stylesheet" href="{{ asset('site') }}/assets/css/khater.css" />
<link rel="stylesheet" href="{{ asset('site') }}/assets/css/khater-responsive.css" />
<!-- Font Awesome -->
