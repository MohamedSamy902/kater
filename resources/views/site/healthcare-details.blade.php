                ...
                <div class="col-xl-3 col-lg-3 ">
                    <div class="sidebar">
                        ...
                        <div class="sidebar__single sidebar__post ">
                            ...
                            <h3 class="sidebar__title" style="color: #005172;margin-top: 10px;">{{ __('site.Healthcare') }}</h3>
                            ...
                            <hr style="height: 2px;">
                            <h3 class="sidebar__title" style="color: #62BB46;">{{ __('site.WellBeing') }}</h3>
                            <marquee width="100%" direction="up" height="236px" scrollamount="2" loop="true"
                                onmouseover="this.stop()" onmouseout="this.start()">
                                <div class="">
                                    <div class="causes-one__single">
                                ...
                                <div class="">
                                    <div class="causes-one__single">
                                        <div class="causes-one__img">
                                            <div class="row">
                                                <div class="col-8"> <img src="{{ asset('site') }}/assets/images//gallery/1P7A0605.JPG"
                                                        style="height: 80px;" alt=""></div>
                                                <div class="col-4">
                                                    <p
                                                        style="font-size: 12px; margin-left: -9px; letter-spacing: -0.05em;">
                        ...
                        <div class="col-xl-3 col-lg-3">
                            <ul style="padding: 20px 0 0 0;">
                                <li class="counter-one__single Provided">
                                    <img src="{{ asset('site') }}/assets/images/healthcare- icon 2022 KF.png" style="height: 50px;"
                                        alt="">
    ...
    <section class="events-carousel-page">
        <div class="container-fluid">
            <div class="events-carousel thm-owl__carousel owl-theme owl-carousel carousel-dot-style"
                ...
                @foreach ($wellBeing->WellBeingDetalis as $WellBeingDetalis)
                    <div class="item px-1">
                        <div class="events-one__single">
                            <div class="causes-one__single">
                                <div class="causes-one__img">
                                    <img src="{{ $WellBeingDetalis->getFirstMediaUrl('wellBeingDetails') }}" style="height: 300px" alt="">
                                    <div class="causes-one__cat">
                                        <p>{{ $WellBeingDetalis->title }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/2.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/3.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <!-- <div class="item px-1">
                                <div class="events-one__single">
                                    <div class="causes-one__single">
                                        <div class="causes-one__img">
                                            <img src="{{ asset('site') }}/assets/images/HihyaConvoys/W4.jpeg" style="height: 300px" alt="">
                                            <div class="causes-one__cat">
                                                <p>Hihya Convoys</p>
                                            </div>
                                        </div>
                ...
                {{-- <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/5.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/6.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/7.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/8.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/9.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
                ...
                <div class="item px-1">
                    <div class="events-one__single">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="{{ asset('site') }}/assets/images/HihyaConvoys/10.jpeg" style="height: 300px" alt="">
                                <div class="causes-one__cat">
                                    <p>Hihya Convoys</p>
                                </div>
                            </div>
