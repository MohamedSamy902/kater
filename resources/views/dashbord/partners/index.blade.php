...
@section('content')
    @component('components.breadcrumb')
        @slot('breadcrumb_title')
            <h3>{{ __('master.slider') }}</h3>
        @endslot
        <li class="breadcrumb-item active">{{ __('master.slider') }}</li>
    @endcomponent
                                    ...
                                    @foreach ($sliders as $slider)
                                        <tr>
                                            ...
                                            <td><img style="max-width: 100px;max-height: 100px;"
                                                    src="{{ $slider->getFirstMediaUrl('slider') != null ? $slider->getFirstMediaUrl('slider') : asset('') }}">
                                            </td>

                                            <td>
                                                <div style="display: flex;">
                                                    <a class="btn btn-outline-primary-2x" style="margin-right: 20px;"
                                                        href="{{ route('sliders.edit', $slider->id) }}">{{ __('master.edit') }}</a>
